...
const Navbar: React.FC = () => {
    ...
    return (
        <motion.div
            ...
            } ${isOpen ? 'bg-black/95 backdrop-blur-xl' : 'bg-gradient-to-b from-black/70 via-black/30 to-transparent'}`}
        >
            <div>
                <h1 className="text-xl font-bold">Kashi Tours</h1>
            </div>
            ...
            >
                <div className="w-6 flex flex-col gap-1">
                    <span className={`block h-0.5 w-full bg-white transition-all duration-300 ${isOpen ? 'rotate-45 translate-y-1.5' : ''}`}></span>
